  ...
  return (
    <div className="w-full h-auto">
        ...
        <div className="w-full flex items-center justify-center text-gray-700 p-4">
            <div className="w-[80%] flex flex-col md:flex-col lg:flex-row items-center p-4 shadow-xl  rounded-lg bg-white mt-4 sm:mt-2 gap-10 max-h-[80vh] overflow-y-auto lg:overflow-hidden">
                ...
                <div className="w-[100%] md:w-[60%] p-2">
                    ...
                    <form action="#" class="space-y-4">
                        <div>
                            <label for="email" classNaùe="block mb-2 text-sm font-medium text-gray-900 ">Email</label>
                        ...
                        <button type="submit" onClick={(e) => handleSubmit(e)} className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-blue-400 sm:w-fit hover:bg-blue-500  focus:outline-none ">Envoyer </button>
                    </form>
                </div>
            </div>
        </div>
